...
/// Animierter Zock/Block-Hintergrund mit dem Login-Button in der Mitte.
...
class _AuthSectionState extends ConsumerState<AuthSection>
  ...
  Widget build(BuildContext context) {
    ...
    final smallHeight =
        screenWidth /
        8.6; // 4 Grafiken nebeneinander mit jeweils 0.2 * height Abstand
    final largeHeight =
        screenWidth / 2; // 1 Grafik (Seitenverhältnis der Grafiken ist 1:2)
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(fontFamily: 'ComradeBold'),
                          ),
                        ),
                        Expanded(
                          child: FittedBox(
